...
* Data-Driven Prediction: Utilizes a robust Gradient Boosting model to make predictions.

* Intuitive Web Interface: A user-friendly Streamlit application for easy input and visualization.

* Engineered Features: Incorporates new features, such as Has_Table_Booking_and_Online_Delivery, to improve model accuracy.

### Technical Stack

* Machine Learning: scikit-learn for data preprocessing and model training.
...
* Check out the project Restaurent rating app by refering the below link.
